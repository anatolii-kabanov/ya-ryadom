...
import { FormLayout, Button, Textarea, FormStatus } from '@vkontakte/vkui';
	...
	render() {
		...
		return (
			<FormLayout>
				...
				></RatingInput>
				{errors?.rating && (
					<FormStatus mode='error'>{errors.rating}</FormStatus>
				)}
				<Textarea
					minLength={1}
					...
					top={
						<span className='flex-between'>
							Комментарий <span>{maxValues.maxText - text.length}</span>
						</span>
					}
