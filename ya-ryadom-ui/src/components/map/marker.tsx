    ...
    return (
        selected
            ...
            : <svg onClick={(e: any) => onClick && onClick(e)} width="17" height="25" viewBox="0 0 35 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill={status ? statusColor[status] : '#F05C44'} d="M8.24448e-05 16.9155C-0.0240118 9.09601 5.48553 2.1748 13.1475 0.426449C20.8255 -1.32992 28.8087 2.46351 32.198 9.51305C34.6636 14.6458 34.6877 19.8588 31.957 24.8392C27.9333 32.1614 23.6847 39.3553 19.5003 46.5812C18.2796 48.6905 15.6774 48.6905 14.4486 46.5732C10.2482 39.3553 6.07985 32.1132 1.95171 24.8552C0.570312 22.4091 -0.00794896 19.7224 8.24448e-05 16.9155Z" />
            </svg>
    )
}
