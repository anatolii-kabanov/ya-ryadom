...
export const moveToPrevious = () => action(HistoryTypes.MOVE_TO_PREVIOUS_VIEW_PANEL);
...
export const openEventById = (payload: number) => action(HistoryTypes.OPEN_EVENT_BY_ID, payload);
