...
export const sendComplaintToEventRequest = (payload: ComplaintForm) => action(ComplaintsTypes.SEND_COMPLAINT_TO_EVENT, payload);
...
export const openEventComplaintForm = (payload: number) => action(ComplaintsTypes.OPEN_EVENT_COMPLAINT_FORM, payload);
export const setSelectedEventId = (payload: number | null) => action(ComplaintsTypes.SET_SELECTED_EVENT_ID, payload);
