...
namespace YaRyadom.Domain.Migrations
{
    ...
    [Migration("20200823194006_Complaints")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YaRyadom.Domain.Entities.YaRyadomComplaint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<int>("YaRyadomFromUserId")
                        .HasColumnName("ya_ryadom_from_user_id")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("YaRyadomFromUserId");

                    b.ToTable("ya_ryadom_complaints");
                });
            ...
            modelBuilder.Entity("YaRyadom.Domain.Entities.YaRyadomNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<int>("YaRyadomUserToSendId")
                        .HasColumnName("ya_ryadom_user_to_send_id")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("YaRyadomUserToSendId");

                    b.ToTable("ya_ryadom_notifications");
                });
            ...
            modelBuilder.Entity("YaRyadom.Domain.Entities.YaRyadomUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("VkNotificationsLastSentDate")
                        .HasColumnName("vk_notifications_last_sent_date")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset>("VkNotificationsLockoutEnd")
                        .HasColumnName("vk_notifications_lockout_end")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("VkNotificationsPerDayCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("vk_notifications_per_day_count")
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<int>("VkNotificationsPerHourCount")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("VkNotificationsLockoutEnd");
            ...
            modelBuilder.Entity("YaRyadom.Domain.Entities.YaRyadomComplaint", b =>
                {
                    b.HasOne("YaRyadom.Domain.Entities.YaRyadomEvent", "YaRyadomEvent")
                        .WithMany("YaRyadomComplaints")
                        .HasForeignKey("YaRyadomEventId")
                        .HasConstraintName("FK_ya_ryadom_event_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YaRyadom.Domain.Entities.YaRyadomUser", "YaRyadomFromUser")
                        .WithMany("YaRyadomMyComplaints")
                        .HasForeignKey("YaRyadomFromUserId")
            ...
            modelBuilder.Entity("YaRyadom.Domain.Entities.YaRyadomNotification", b =>
                {
                    b.HasOne("YaRyadom.Domain.Entities.YaRyadomEvent", "YaRyadomEvent")
                        .WithMany("YaRyadomNotifications")
                        .HasForeignKey("YaRyadomEventId")
                        .HasConstraintName("FK_ya_ryadom_event_id");

                    b.HasOne("YaRyadom.Domain.Entities.YaRyadomUser", "YaRyadomUserToSend")
                        .WithMany("YaRyadomNotificationsToMe")
                        .HasForeignKey("YaRyadomUserToSendId")
