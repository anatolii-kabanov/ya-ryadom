...
using YaVDele.API.MappingProfiles;
using YaVDele.API.Services.Implementations;
...
namespace YaVDele.API
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddDbContext<YaVDeleDbContext>();
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env, YaVDeleDbContext dbContext)
		{
